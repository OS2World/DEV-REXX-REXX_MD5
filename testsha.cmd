/* Test the  "dll" SHA-1
   This uses the test strings found in FIPS PUB 180
   algorithim  */
...
say
say ' For: "abc" '
say "   SHA should be: A9993E36 4706816A BA3E2571 7850C26C 9CD0D89D         "
a1=srx_sha('abc')
say "       from dll: " a1
say
...
say ' For: "abc" '
say " SHA should be: 84983E44 1C3BD26E BAAE4AA1 F95129E5 E54670F1"
a1=srx_sha(abc)
say "      from dll:" a1
say

abc=copies('a',1000000)
say ' For: 1 million "a" characters'
say " SHA should be: 34AA973C D4C4DAA4 F61EEB2B DBAD2731 6534016F"
a1=srx_sha(abc)
say "      from dll:" a1
say
